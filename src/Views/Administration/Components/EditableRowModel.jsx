...
const EditableRowModel = ({model, brands, handleFormChange, handleCancelClick}) => {
    ...
    return(
        <tr key={model.modelId} style={tableStyle}>
            ...
            <td style={tableStyle}>
                <input type="date" name="launch" defaultValue={format(new Date(model.launch), "yyy-MM-dd")} required="required" placeholder="launch date" onChange={handleFormChange} style={inputStyle}></input>
            </td>
